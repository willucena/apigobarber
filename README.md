...
<ul>
  <li>Para a versão web, <a href="https://github.com/willucena/gobarberweb">clique aqui</a>.</li>
  <li>Para a versão mobile, <a href="https://github.com/willucena/appgobarber">aqui</a>.</li>
</ul>
...
- Clone o repositório ```git clone https://github.com/willucena/apigobarber.git```
- Vá até o diretório ```cd apigobarber```
